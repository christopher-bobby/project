  ...
  <body>
    ...
    <section class="section-main">
      <div class="container container-sm">
        <div class="heading">
          <h1>Forms</h1>
          <p class="lead mb-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci natus quod delectus hic illum commodi eveniet sequi laborum, ad, officia ratione eligendi nihil deleniti nostrum debitis iure voluptates cum fugit.</p>
        </div>
